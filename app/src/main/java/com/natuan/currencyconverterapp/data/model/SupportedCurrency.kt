package com.natuan.currencyconverterapp.data.model
...
class SupportedCurrency {
    companion object {
        ...
        val CURRENCIES: String get() { return ALL.keys.joinToString(",") }
        val ALL = hashMapOf(
            ...
            "CHF" to "Swiss Franc",
            "CLF" to "Chilean Unit to Account (UF)",
            "CLP" to "Chilean Peso",
            "CNY" to "Chinese Yuan",
